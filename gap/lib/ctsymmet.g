# -*- Mode: shell-script -*- 
CVSID("$Id: ctsymmet.g 1667 2005-05-29 08:03:20Z uyvorone $");
...
##
##  Simplified and speeded up at Jean Michel's Suggestion
##
BetaSet := function(alpha)
   if alpha = [] then return []; fi;
   return Reversed(alpha)+[0..Length(alpha)-1];
end;
