...
/****************************************************************************
**
*F  PrAgWord(<stream>, <hdAgWord> , <indent>)  . . . . . . . . . . . . . . . . prints a T_AGWORD
**
...
*/
    ...
    void        PrAgWord(STREAM stream, Bag hdAgWord, int indent)
{
        TypSword        * pt, * ptEnd;
        Bag       hdAgGroup;
...
void    PrAgWord( stream, hdAgWord, indent)
        ...
        int       indent;
    {
        ...
        SyFmtPrint ( stream, "agword( %d; ", *PTR_BAG( hdAgWord ) / NUM_TO_INT(4) );
        pt    = PTR_AW( hdAgWord );
...
/****************************************************************************
**
*F  PrAgExp(<stream>, <hdAgExp>, <indent>)  . . . . . . . . . . . . . . . . .  prints a T_AGEXP
**
...
*/
    ...
    void        PrAgExp(STREAM stream, Bag hdAgExp, int indent)
{
        TypExp          * pt, * ptEnd;
...
/****************************************************************************
**
*F  PrAgList(<stream>, <hdAgList>, <indent>)  . . . . . . . . . . . . . . . . prints a T_AGLIST
**
...
*/
    ...
    void        PrAgList(STREAM stream, Bag hdAgList, int indent)
{
        TypSword        * pt, * ptEnd;
        int             toggle;
...
/****************************************************************************
**
*F  PrAgen(<stream> ,<hdAgGrp>, <indent>) . . . . . . . . . . . . . . . . . . . prints a T_AGEN
**
...
void    PrAgen(STREAM stream, Bag hdAgen, int indent)
{
