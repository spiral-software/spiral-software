...
void InitHooks(void) {
    ...
    lobj = NewList(0); SET_BAG(FindIdent("HooksBeforeOpenInput"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksBeforeCloseInput"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksAfterOpenInput"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksAfterCloseInput"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksSessionStart"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksSessionEnd"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksBrkHighlightStart"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksBrkHighlightEnd"), 0, lobj);
    lobj = NewList(0); SET_BAG(FindIdent("HooksEditFile"), 0, lobj);
