...
static Int TEST_BYTES = (Int)TEST_BLOCK_SIZE * (Int)TEST_BLOCKS;
 ...
 */
#if 0
static void MDString (char *inString, unsigned int hash[4])
{
  MD5_CTX mdContext;
...
#else
void MDString (char *inString, char *hash)
{
  int i;
  MD5_CTX mdContext;
  unsigned int len = strlen (inString);
