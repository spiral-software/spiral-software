...
*/
extern  void            PrRec (STREAM stream, Obj hdRec, int indent);
...
**  '<record> . <name>'
*/
extern  void            PrRecElm (STREAM stream, Bag hdElm, int indent);
...
**  '<record>.<name> := <expr>;'
*/
extern  void            PrRecAss (STREAM stream, Bag hdAss, int indent);
...
**
*/
extern  void            PrRecName (STREAM stream, Bag hdNam, int indent);
