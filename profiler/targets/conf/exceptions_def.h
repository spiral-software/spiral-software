...
/* The remaining portion of this file is patched cexcept.h by Adam
   M. Costello and Cosmin Truta. 

   The file was modified to add __FILE__, __LINE__, and __func__, to 
   the exception context. Additions are in define_exceotion_context
   and in Throw. They are delimited with comments. 
...
#else
#define __func__ "unsupported"
#endif
#endif

#define Throw \
  for ( /*start patch*/ the_exception_context->func = __func__, \
	the_exception_context->file = __FILE__, \
	the_exception_context->line = __LINE__ /* end patch */\
