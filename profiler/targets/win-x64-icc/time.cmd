...
iclvars.bat intel64 > nul && make -R -C ../../targets/win-x64-icc GAP=%SGBETEMPDIR%\testcode.c STUB=%SGBETEMPDIR%\testcode.h CC="icl" CFLAGS="/O3 /G7 /QxSSSE3" OUTDIR=%SGBETEMPDIR% -s > time.txt
